...
def main():
    ...
    if args.save_reward:
        save_dir = os.path.join(args.root_dir, 'dexart_'+args.task_name+'_expert_reward.zarr')
        cprint('Saving Reward Mode, dataset will be saved at {}'.format(save_dir), 'green')
    else:
    ...
    with tqdm(total=num_episodes) as pbar:
        ...
        while num_success < num_episodes:
            ...
            if eval_success:
                ...
                reward_arrays.extend(reward_arrays_sub)
